                                         ...
                                         box(title="Enriched gene sets in differential regions across clusters", width=NULL, status="success", solidHeader=T,
                                             ...
                                             column(12, align="left",
                                                         mainPanel(tabsetPanel(id='enr_tables',
                                                                          ...
                                                                          tabPanel("In depleted loci", div(style = 'overflow-x: scroll', DT::dataTableOutput('over_enrich_table'))),
                                                                          tabPanel("In enriched loci", div(style = 'overflow-x: scroll', DT::dataTableOutput('under_enrich_table')))), width=12),
                                                    br(), br(), br(), br(), br(),
