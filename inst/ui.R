                                ...
                                fluidPage(
                                  column(width=6,
                                         ...
                                         shinydashboard::box(title = tagList(shiny::icon("cubes"),"Consensus Hierarchical Clustering"),
                                                             ...
                                                             column(12, offset = 0,
                                                                    div(style="display: inline-block;vertical-align:top; width: 200px;", sliderInput("maxK", "Max cluster :", min=2, max=20, value=5, step=1)),
                                  ...
                                  column(width=6,
                                         shinydashboard::box(title="Select Cluster Number", width=NULL, status="warning", solidHeader=T,
                                                             align="left",
                                                             column(width=6,selectInput("nclust", br("Number of Clusters:"), choices=c("",2:10))),
