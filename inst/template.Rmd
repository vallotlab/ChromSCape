...
```{r}
plot_reduced_dim_scExp(scExp_cf, color_by = "sample_id")
```

### UMAP - total counts

```{r}
plot_reduced_dim_scExp(scExp_cf, color_by = "total_counts")
```
...
```{r}
plot_reduced_dim_scExp(scExp_cf, color_by = "cell_cluster")
```
